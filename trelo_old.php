...
$sql = $db->prepare("SELECT *,DATE_FORMAT(newduedate, '%b-%d-%Y') as newduedate FROM `todo` WHERE (createdfk = :id or asignto = :id) AND catstatus = '1' AND status = '0'");
                        ...
                        <div class="row page-titles">
                            <div class="row col-md-12 " >
                                <div class=" col-md-5 align-self-center">
                                    <h4 class="text-themecolor">Trelo-Taskmanagement</h4>
                                </div>
                                <div class="col-md-7">
                        ...
                        <div class="row" style="height: auto;" >
                            <div class="col-md-12" style="height: auto;" >
                                <div class="card" style="height: auto;" >
                                    <div class="card-body">
                                        <div class="col-lg-12">
                                            <a href="#" id="" class="btn btn-info m-r-10 " data-toggle="modal" data-target="#addcatmodal">Add Category</a>
                                        </div>
                                                ...
                                                <ul id="sortable1" data-id="todo" class="sortable connectedSortable ui-sortable">
                                                    ...
                                                    if (!empty($data)) 
                                                    {
                                                        foreach ($data as $taskRow) 
                                                        {
                                                            ...
                                                            {
                                                                $userdata = $db->prepare("SELECT id,firstname,lastname,username FROM users WHERE id = :id");
                                                                $userdata->bindParam(":id",$taskRow['asignto']);
                                                                $userdata->execute();
                                                            ...
                                                            <li style="background: <?= $taskRow["colorcode"]; ?>" class="text-row ui-sortable-handle"  id="<?= $taskRow["id"]; ?>" data-id="<?= $taskRow["id"]; ?>"> 
                                                                ...
                                                                <div id="li" data-id="<?= $taskRow["id"]; ?>" style="width: 80%;display: inline-block;padding: 15px 10px;"><?= $taskRow["todoTitle"]; ?></div>

                                                                <button style="float:right;padding: 15px 10px 15px 0px;" class="btn close" title="Close Task" id="deleteButton" data-id="<?= $taskRow["id"]; ?>"><span class="fa fa-close fa-sm"></span></button>
                                                                ...
                                                                if(!empty($taskRow["asignto"]))
                                                                {
                                                                    if($taskRow["asignto"] != $_SESSION['UserID'])
                                                                    {
                                                                        ?>
                                                                        <div style="text-align: right;padding-right: 10px;" >
                                                                            <span title="Asigned To <?= $udata["firstname"]." ".$udata["lastname"]; ?>" style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong><?= '@'.$udata["username"]; ?> </strong></span>-
                                                                            <span title="Due Date" style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong><?= $taskRow["newduedate"]; ?> </strong></span>
                                                                        </div>
                                                                        <?php
                                                                    }
                                                                    else
                                                                    {
                                                                        ?>
                                                                        <div style="text-align: right;padding-right: 10px;" >
                                                                            <span style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong>@you </strong></span>-
                                                                            <span title="Due Date" style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong><?= $taskRow["newduedate"]; ?> </strong></span>
                                                                        </div>
                                                                        <?php   
                                                                    }
                                                    ...
                                                    <div class="status-card sortable_row_connect" card-id="<?= $keys['id'] ?>">
                                                        <div class="card-header">
                                                            ...
                                                            <div class="catin" name="catin<?= $keys["id"] ?>">
                                                                ...
                                                                <textarea type="text" id="catin" name="catin<?= $keys["id"] ?>"></textarea> 
                                                        ...
                                                        <ul id="<?= $keys["id"];  ?>" data-id="<?= $keys['id'];  ?>" class="sortable connectedSortable ui-sortable">
                                                            ...
                                                            if(!empty($data))
                                                            {
                                                                foreach ($data as $key) 
                                                                {
                                                                    ...
                                                                    {
                                                                        $userdata = $db->prepare("SELECT id,firstname,lastname,username FROM users WHERE id = :id");
                                                                        $userdata->bindParam(":id",$key['asignto']);
                                                                        $userdata->execute();
                                                                        $udata = $userdata->fetch();    
                                                                    }
                                                                    ?>
                                                                    <li style="background: <?= $key["colorcode"]; ?>"  class="text-row ui-sortable-handle" id="<?= $key["id"]; ?>" data-id="<?= $key["id"]; ?>"> 
                                                                        <div id="li" data-id="<?= $key["id"]; ?>" style="width: 80%;display: inline-block;padding: 15px 10px;"><?= $key["todoTitle"]; ?></div>
                                                                        <button style="float:right;padding: 15px 10px 15px 0px;" class="btn close" title="Close Task" id="deleteButton" data-id="<?= $key["id"]; ?>"><span class="fa fa-close fa-sm"></span></button>
                                                                        ...
                                                                        if(!empty($key["asignto"]))
                                                                        {
                                                                            if($key["asignto"] != $_SESSION['UserID'])
                                                                            {
                                                                                ?>
                                                                                <div style="text-align: right;padding-right: 10px;" >
                                                                                    <span title="Asigned To <?= $udata["firstname"]." ".$udata["lastname"]; ?>" style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong><?= '@'.$udata["username"]; ?></strong> </span>-
                                                                                    <span title="Due Date" style="margin-bottom: 0px;color: grey;font-size: 11px;" ><strong><?= $key["newduedate"]; ?> </strong></span>
                                                                                </div>
                                                                                <?php   
                                                                            }
                                                                            else
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row col-md-12 form-group" >
                                        <div class="col-md-11" style="display: inline-flex;align-items: center;" >
                                            <input class="colorpre" type="color" id="colorpre" name="colorcode" value="#ffffff">    
                                            <div>
                                                <li class="text-row ui-sortable-handle" id="preview" style="border: 1px solid;width: 297px;margin-left: 10px;margin: 0px;list-style: none;background: #ffffff" > 
                                                    ...
                                                    <hr style="margin: 0px;">
                                                    <div style="text-align: right;padding-right: 10px;">
                                                        <span style="margin-bottom: 0px;color: grey;font-size: 11px;"><strong>@username </strong></span>-
                                                        <span style="margin-bottom: 0px;color: grey;font-size: 11px;"><strong>#Jan-1-2019 </strong></span>
                                                    </div>
                                                </li>
                                            </div>
                                        </div>
