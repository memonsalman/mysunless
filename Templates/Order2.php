                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    ...
                    <tbody><tr>
						...
						<div class="col-lg-12" style="width:100%">
                            ...
                            <div class="col-lg-4 pull-left" style="width:40%; float: left;">      
                            ...
                            <div><span class="CustomerName1"></span>asdfs</div>

                            <div><span class="CustomerMail1"></span>fasdfsaf</div>

                            <div><span class="CustomerAdders1"></span>fdsafdfds</div>

                            <div><span class="CustomerAdders21"></span>fsadfsadf</div>

                            <div><span class="Customerphone1"></span>fdsafdf</div>
                              ...
                              <tr id="order_popup" class="order_popup">
                                ...
                                <div class="col-lg-12" style="width:100%;">
                                    ...
                                    <div class="col-lg-3 pull-right" style="width:40%; float: right; padding-top:25px;">
                                      ...
                                      <div><span>Membership </span> : <span class="membershiptotalprice1"></span></div> <hr>
                                    ...
                                    <div class="col-lg-6 pull-left" style="width:40%;float: left;padding-top:30px;">
