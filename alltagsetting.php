...
if(isset($_POST['Buttonone']))
{
	...
	$buttonupdate= $db->prepare("UPDATE `ButtonSetting` SET button_name=:button_name WHERE button_id='C84'"); 
    $buttonupdate->bindParam(':button_name', $button_name, PDO::PARAM_STR);
    $buttonupdates = $buttonupdate->execute();


    $buttonupdate2= $db->prepare("UPDATE `ButtonSetting` SET button_name=:button_name2 WHERE button_id='C85'"); 
    $buttonupdate2->bindParam(':button_name2', $button_name2, PDO::PARAM_STR);
    $buttonupdates2 = $buttonupdate2->execute();

    $buttonupdate3= $db->prepare("UPDATE `ButtonSetting` SET button_name=:button_name3 WHERE button_id='C86'"); 
    ...
    if(isset($_POST['Titleone']))
{
     ...
     $titileupdate= $db->prepare("UPDATE `PageTitle` SET TitleName=:title_name WHERE id='23'"); 
                                   ...
                                   <div class="tab-pane " id="home3" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <form class="form-horizontal" id="Cbuttonnemae2" method="post">
                                            ...
                                            <div class="form-group">
                                            <label>Company Information Title *</label>
...
$(document).ready(function() {
                ...
                //active class
                setInterval(function(){$(".settag").addClass("active");}, 10);
            ...
            messages: {             
                Buttonone:  "Please enter add tag button name",
                Buttonone2:  "Please submit tag button name",
                Buttonone3:  "Please cancel tag button name",
...
$("#Cbuttonnemae2").validate({
            ...
            messages: {             
                Titleone:  "Please enter list of tag title",
