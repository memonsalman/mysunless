...
, 
{
    ...
    "render": function(data,type,row,meta) {
      ...
      var getTimeWidget = getTimeLine(dateDiff);
      return "<a class='btn btn-info btn-xs' id='editorder' title='Edit Order' href='EditOrder.php?action=edit&id="+encodedId+"&cid="+getUid+"'><span class='fa fa-edit'></span></a>"+'<a href="" id="viewButton" style="color:white;" title="View Invoice" class="viewButton  btn btn-success btn-xs cutbut" data-id="' + encodedId + '"><span class="fa fa-eye"></span></a>'+  "<br /><div class='usertime'><div class='activeusertime  badge badge-pill badge-primary'>"+getTimeWidget+"</div></div>";
...
},
{
    ...
    render:function(data,type,row,meta)
    {
     ...
     {
        subdetail = subdetail+'<span class="moreellipses">' + ellipsestext+ '</span><span class="morecontent" ><span class="remainingDetail" style="display:none;">'+remainingDetail+'</span><a href="" class="morelink" style="display: block;">' + moretext + '</a></span>';

    }
    ret+= ''+subdetail+'';
    ret +=' <br /> </span><span> <h6 style="display: inline-block;">Note created date : </h6> </span>'+dateFormat+'</div>';
