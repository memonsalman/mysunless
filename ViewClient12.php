...
@$id=base64_decode($_GET['id']);
$stmt_appo= $db->prepare("SELECT event.datecreated as newdate,event.title,event.EventDate,event.cid,Service.ServiceName,event.id FROM `event`JOIN Service on event.ServiceName=Service.id WHERE cid=:id ORDER BY `event`.`datecreated` DESC"); 
...
if(isset($_REQUEST['mytitle']))
{
    ...
    echo  json_encode(["resonse"=>$result_event_docf]);die; 
}
...
<div class="profiletimeline1" style="padding: 0px;">
    ...
    <?php
    foreach ($result_note as $row) 
    {
        ?>
        <div class="activedatea parent_of_operation row">
            <?php
            $id=$row['clientid'];
    ...
    // $username=@$allresult['FirstName'];
            ...
            ?>
            <?php 
            $start  = date_create($row['datecreated']);
    $end    = date_create(); // Current time and date
    $diff   = date_diff( $start, $end );
    ?>


    <div class="activeuserimage col-lg-2 text-center">
        <?php   
        if (empty($img)) 
        {
            ?>
            <img src="<?php echo base_url; ?>/assets/images/noimage.png" alt="user" class="" height="80px" width="80px">
            <?php
        } 
        elseif (file_exists(DOCUMENT_ROOT.'/assets/userimage/'.$img)) 
        {
            ?>
            <img src="<?php echo base_url; ?>/assets/userimage/<?php echo @$img; ?>" alt="user" class="" height="80px" width="80px">
            <?php
        }
        else 
        {
    ...
    <div class="activeuserdetial col-lg-8 mt-2">
        <h5>
            <b>
                <?php echo $row['noteTitle']; ?> 
            </b>
        </h5>
        <span> <?php echo $row['noteDetail']; ?> </span>
    </div>
    <div class="usertime col-lg-2 text-center">
        ...
        <div class='displayOperation'>
            <a class='btn btn-info btn-xs ' title='Edit Note' href="AddNote.php?action=edit&id=<?php echo base64_encode($row['id']) ; ?>&cid=<?php echo $_GET['id'] ;?>"><span class='fa fa-edit'></span></a>
            <a class='btn btn-danger btn-xs ' id='deleteNote' title='Delete Note' href="AddNote.php?action=delete&id=<?php echo base64_encode($row['id']) ; ?>&cid=<?php echo $_GET['id'] ;?> "><span class='fa fa-trash'></span></a>
        </div>
    </div>
</div>
<div class="clerfix">
              ...
              <div class="modal-dialog modal-lg" style="max-width: 1100px;">
                ...
                <div class="form-group">
                  ...
                  <p id="datepairExample" style="display: flex">
                   ...
                   <input type="text"  name="timepicker" class="timepicker1" id="timepicker1" />
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
...
<div class="profiletimeline1">
    ...
    <div class="activeuserdetial col-lg-8">
        <h5>
            <b>
                <?php echo $row['title']; ?> 
            </b>
    ...
    <div class="usertime col-lg-2 text-center">
        ...
        <div class='displayOperation'>
            <a class='btn btn-info btn-xs EditButton' style="color: white" id="EditButton" title='Edit Appointment' data-id="<?php echo base64_encode($row['id']) ; ?>"><span class='fa fa-edit'><span></a> 
               <a class='btn btn-danger btn-xs ' style="color: white" id='deleteAppointment' title='Delete Appointment' data-id="<?php echo base64_encode($row['id']) ; ?>" ><span class='fa fa-trash'><span></a>
               </div>
           </div>
       </div>
...
<div class="profiletimeline1">
    ...
    <div id="drop-area_1">
        ...
        <div class="clerfix" style="clear: both;">
                                        ...
                                        <button class="btn btn-info pull-left m-r-10" id="sendMail" data-toggle="modal" data-target="#sendMailModal"><i class="fa fa-send">
                                        </i> SEND MAIL</button>
                                        <button class="btn btn-info pull-left m-r-10" id="sendSms" data-toggle="modal" data-target="#sendSmsModal"><i class="fa fa-envelope">
                                        </i> SEND SMS</button>


                                        <!-- End contact infp design rahul-->
                                    ...
                                    <h4 class=" p-t-30 db">Phone</h4>
                                        <p style="font-size: 16px;" ><?php echo $Phone ; ?></p>  
                                    <h4 class=" p-t-30 db">Address</h4>
                                        <p style="font-size: 16px;" ><?php echo $Address.', '.$City.', '.$State.', '.$Zip.', '.$Country ; ?></p>

                                         <button class="btn btn-info pull-right m-r-10" id="sendMail" data-toggle="modal" data-target="#sendMailModal"><i class="fa fa-send">
                                                        </i> SEND MAIL</button>
      <button class="btn btn-info pull-right m-r-10" id="sendSms" data-toggle="modal" data-target="#sendSmsModal"><i class="fa fa-envelope">
                                                        </i> SEND SMS</button>
                                                    -->
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label>To *</label>
                                                                        <input type="text" name="To[]" id="To" class="form-control" placeholder="To" value="<?php echo $email ;?>" readonly>
                                                                    </div>
                                                                    <div class="form-group">
                                                    ...
                                                    $start  = date_create($row['comtime']);
                                                            ...
                                                            <!-- <td style="width:40px">
                                                                ...
                                                                <?php 
                                                                        ...
                                                                        <div class="smsdiv ctype" style="background: #54a1f8;">
                                                                            <span> SMS </span>
                                                                            <span class="label label-info m-r-10">SMS</span>
                                                                        </div>
                                                                        <?php
                                                                            } 
                                                                            else 
                                                                        ...
                                                                        <div class="maildiv ctype" style="background: #000000;">
                                                                            <span> EMAIL </span>
                                                                            <span class="label label-info m-r-10">EMAIL</span>
                                                                        </div>
                                                              ...
                                                              <td class="max-texts"> 
                                                                <span class="view_Message_button viewMailModel" data-id="<?php echo $row['id']; ?>">  
                                                                   <?php 
                                                                   ...
                                                                   if ($row['type']=="sms")
                                                                   {
                                                                      ...
                                                                      <span class="label label-warning m-r-10">SMS</span>
                                                                  ...
                                                                  else 
                                                                  {
                                                                    ...
                                                                    <span class="label label-success m-r-10">EMAIL</span>
                                                        ...
                                                        <!-- <td class="text-right"><?php echo  @$row['comtime']; ?> </td> -->
                                                        <td class="">
                                                            <?php 
                                                                    //MM:DD:YYYY
                                                            @$explodetime =  explode(" ",@$row['comtime']);
                                                            $timestamp = strtotime($explodetime[0]);
                                                            $newDate = date("m-d-Y", $timestamp);
                                                            echo @$newDate."    ".date("g:i a", strtotime(@$explodetime[1]));
...
// {
    ...
    // $username=@$allresult['FirstName'];
                                                                        ...
                                                                        ?>
                                                                        <?php 
                                                                        $start  = date_create($row['odatecreated']);
    $end    = date_create(); // Current time and date
    $diff   = date_diff( $start, $end );
    ?>
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="activeuserdetial image text-center">
                <h5>
                    <b>
                        <?php $myorderdate = explode(" ",$row['odatecreated']);
                        $ordate=date_create($myorderdate[0]);
                        echo date_format($ordate,"d M, Y");
                        ?> 
                    </b>
                </h5>
                <?php if(!empty($row['ProductTitle'])) {?> 
                    <span><b>
                        Product Name :
                    </b> <?php echo $row['ProductTitle']; ?> </span>
                    <br>
                <?php } else {}?>
                <?php if(!empty($row['Name'])) {?>
                    <span><b>
                        Package Name :
                    </b> <?php echo $row['Name']; ?> </span>
                    <br>
                <?php } else {}?>
                <?php if(!empty($row['ServiceName'])) {?>
                    <span><b>
                        Service Name :
                    </b> <?php echo $row['ServiceName']; ?> </span>
                <?php } else {}?>
            </div>
        </div>
        <!--col-5- over -->
        <div class="col-lg-2 text-center">
            <div class="usertime">
                ...
                <div class='displayOperation'>  
                    <div class="row">
                        <div class="col"> 
                         <a class='btn btn-info btn-xs' id='editorder' title='Edit Order' href="EditOrder.php?action=edit&id=<?php echo base64_encode($row['orid']) ; ?>&cid=<?php echo $_GET['id'] ;?>"><span class='fa fa-edit'></span></a>
                         <button class='btn btn-primary btn-xs' id='viewButton' title='View Invoice' data-id="<?php echo base64_encode($row['orid']) ; ?>"><span class='fa fa-eye'></span></button>   
                     </div>  
                 </div>
...
// {
    ...
    <div class="row">
        <div class="col-lg-2">
            <div class="activeuserimage text-center">
                <?php   
                if (empty($img)) 
                {
                    ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="activeuserdetial">
                ...
                if(!empty($row['Noofvisit']))
                {   
                    ?>
                    <span><b>Service  Remaining: </b> <?php echo $row['Noofvisit']; ?></span>
        ...
        <div class="col-lg-2 text-center">
            <div class="usertime">
                ...
                <div class='displayOperation'>  
                    <div class="row">
   <!--  <div class="col-md-4"> 
   <button class='btn btn-info btn-sm pull-right packaeditorder' id='packaeditorder' title='Edit package' data-id="<?php echo base64_encode($row['id']) ; ?>"><span class='fa fa-edit'></span></button></div>
<div class="col-md-4">
    <button class='btn btn-danger btn-sm pull-left packaeditorderviewButton' id='packaeditorderviewButton' title='Cancel Pcakage' data-id="<?php echo base64_encode($row['id']) ; ?>"><span class='fa fa-times'></span></button>   
</div> -->
</div>
      ...
      <div class="modal-body">
        ...
        <div class="customersdetalistree">
            ...
            <div class="form-group">
                ...
                <input autocomplete="nope"  placeholder="Enter your address"  class="form-control" name="Address"  type="text" value=""></input> 
...
<script src="https://cdn.jsdelivr.net/jquery.validation/1.16.0/additional-methods.min.js"></script>
                           ...
                           /* $(document).on('mouseover','.card-body',function(){
                            ...
                            $("#NewDocument").submit(function(e) {
                                  ...
                                  rules: {
                                    ...
                                    document: {
                                      required: true,
                                      extension: "jpeg|jpg|xlsx|doc|pdf|txt|csv"
                                    }
                                  }
                                ,
                                messages: {
                                ...
                                ,submitHandler: function(form) {
                                    ...
                                    jQuery.ajax({
                                        ...
                                        processData: false,
                                        url:'<?php echo EXEC; ?>Exec_client_attech.php',
                                        success: function(data)
                                        {
                                            if(data.resonse2)
                                            {
                        ...
                        <script>
                                    $(document).ready(function() {
                                        ...
                                        var myPicker = $('#timepicker1').wickedpicker(options);
                                       });
                        ...
                        <script>
                            ...
                            //     var myPicker = $('#timepicker1').wickedpicker(options);
                                ...
                                // $('.timepicker1').onclick(function(){
                                //             console.log("asdas");

                                // });

                                // $("#changeTo2PM").click(function() {
...
<script type="text/javascript">
    $(document).ready(function(){
                        ...
                        smsTo: {
                            ...
                            submitHandler: function() {
                                ...
                                jQuery.ajax({
                                    ...
                                    type:"post",
                                    data:data,
                                    url:'<?php echo EXEC; ?>Exec_Send_SMS.php',
                                    success: function(data)
                                    {
        ...
        $(".view_Message_button").click(function(){
...
<script>
    ...
    function createFormData(image) {
                        ...
                        $('#listofcalserd').on('change',function(){
                            ...
                            var clinetid = '<?php echo $ClientId; ?>';
                            $.ajax({
                                url: "?action=getfilebyname",
                                type: "POST",
                                dataType: 'json',
                                data: {
                                    mytitle:mytitle,clinetid:clinetid}
                                    ,
                                    success: function(data){
                                        $('#drop-area_1').html('');
                                        $.each(data.resonse, function(k,v)
                                        {
                                           ...
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/images/xsl.png" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                           else if(fileExtension=='doc')
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/images/msdoc.png" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                           else if(fileExtension=='pdf')
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/images/pdf.png" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                           else if(fileExtension=='txt')
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/images/txt.png" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                           else if(fileExtension=='csv')
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/images/export-csv.png" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                           else
                                           {
                                               $('#drop-area_1').append('<div class="activedatea parent_of_operation myfilelist"><div class="activeuserdetial"><img src="<?php echo base_url; ?>/assets/ClientDocs/'+v.document+'" alt="user" class="" height="50px" width="50px"><h5><b><a href="<?php echo base_url; ?>/assets/ClientDocs"'+v.document+'>'+v.fileName+'</a></b></h5></div></div>');
                                           }
                                       }
                                       );
                                        $(".Loader").hide();
...
$("#eventenddated").change(function(){
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            service_star_timed:service_star_timed,service_end_timed:service_end_timed,clinetid:clinetid}
            ,
            success: function(data){
                $('#drop-area_1').html('');
                $.each(data.resonse, function(k,v)
