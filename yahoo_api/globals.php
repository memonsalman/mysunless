...
//define('OAUTH_CONSUMER_KEY', 'dj0yJmk9a1VRNmFtbWhRQzg3JmQ9WVdrOWVrMTFZV1prTlRBbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD0zNg--');

// new
define('OAUTH_CONSUMER_KEY', 'dj0yJmk9Zlg5MkdPRENES1g3JmQ9WVdrOVRHcEZOMHh3Tm5VbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmc3Y9MCZ4PWMz');

//define('OAUTH_CONSUMER_SECRET', 'cc9dbeb410b020264780c96dd3e59e38839625f6');
//define('OAUTH_CONSUMER_SECRET', 'e0a50749bf7cd391aea3cf4a8073afff1c56e3b8');

// new
define('OAUTH_CONSUMER_SECRET', 'e06ec0e192abf049fb5a269e0eb8c4f30cd0d793');
...

{
  ...
  //$url = 'https://social.yahooapis.com/v1/user/me/contacts;count=1000';
  ...
  if (! empty($response)) {
   ...
   $yahoo_email_info = array();

   if(!empty($yahoo_array))
		 ...
		 foreach($values->contact as $keys=>$values_sub){
			...
			// print_r($values_sub);
			 ...
			 //echo $values_sub->fields[1]->value->givenName;
			   ...
			   foreach ($values_sub->fields as $infokey=>$info_name)

         {

              if($info_name->type == 'name')

              {

                 if(is_object($info_name->value))

                 {

                  $yahoo_email_info[$keys]['name'] = $info_name->value->givenName;
...

                 {
                  ...
                  $yahoo_email_info[$keys]['name'] = $info_name->value;
...

              {
                ...
                if($info_name->type == 'email')

                {

                  $yahoo_email_info[$keys]['email'] = $info_name->value;   
