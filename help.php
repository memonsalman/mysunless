...
if(isset($_GET['action']) && $_GET['action']=="enquiry"){
    ...
    $other['--TITLE--'] = $Subject;
    $other['--Email--'] = $_POST['e_email'];
    $other['--Phone--'] = $_POST['e_phone'];
    $other['--MESSAGE--'] = nl2br($_POST['e_msg']);
...
<style type="text/css">
   ...
   /* .main-slider{
        ...
        .main-slider {
            ...
            background-image: url('./assets/images/help-head-bg.svg');
...
<script>
    ...
    $(document).on("click",".faq_title",function(){
    	...
    	if($(this).hasClass('collapsed')){
    		$(this).find(".arrow-rotate").addClass("down");
    	}else{
    		$(this).find(".arrow-rotate").removeClass("down");
    	}
