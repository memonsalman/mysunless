...
if($_SESSION['usertype']!="Admin")
{
   ...
   $button1= $db->prepare("SELECT button_name FROM `ButtonSetting` where  button_id='C87'"); 
    $button1->execute();
    $all_button1 = $button1->fetch(PDO::FETCH_ASSOC);
    $B1=$all_button1['button_name'];

    $button2= $db->prepare("SELECT button_name FROM `ButtonSetting` where  button_id='C88'"); 
    $button2->execute();
...
if(isset($_POST['Buttonone']))
{
	...
	$buttonupdate= $db->prepare("UPDATE `ButtonSetting` SET button_name=:button_name WHERE button_id='C87'"); 
    $buttonupdate->bindParam(':button_name', $button_name, PDO::PARAM_STR);
    $buttonupdates = $buttonupdate->execute();

    $buttonupdate2= $db->prepare("UPDATE `ButtonSetting` SET button_name=:button_name2 WHERE button_id='C88'"); 
  ...
  $title1= $db->prepare("SELECT TitleName FROM `PageTitle` where id='24'"); 
  $title1->execute();
    ...
    if(isset($_POST['Titleone']))
{
     ...
     $titileupdate= $db->prepare("UPDATE `PageTitle` SET TitleName=:title_name WHERE id='24'"); 
...
<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#home3" role="tab"><span class="hidden-sm-up"><i class="fas fa-heading"></i></span> <span class="hidden-xs-down">Page Setting</span></a> </li>
                            ...
                            <div class="Loader"></div>
                                    	...
                                    	<form class="form-horizontal" id="Cbuttonnemae" method="post">
											...
											<div class="form-group">
											<label>Cancel Note Button *</label>
                                   ...
                                   <div class="tab-pane " id="home3" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <form class="form-horizontal" id="Cbuttonnemae2" method="post">
                                            ...
                                            <div class="form-group">
                                            <label>Add New Note Title *</label>
...
$(document).ready(function() {
                ...
                //active class
                setInterval(function(){$(".setnote").addClass("active");}, 10);
            ...
            messages: {             
                Buttonone:  "Please enter add note button",
                Buttonone2:  "Please enter cancel note button",
          ...
          $(".Loader").show();
            ...
            messages: {             
                Titleone:  "Please enter Company Information title",
