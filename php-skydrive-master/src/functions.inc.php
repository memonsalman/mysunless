...
// define("client_id", "0000000040234465");

// define("client_secret", "uofnZFT432pnyWMDW63;+#]");

// define("callback_uri", "https://mysunless.com/crm/php-skydrive-master/example/callback.php");

// define("skydrive_base_url", "https://apis.live.net/v5.0/");

define("client_id", "c17a593c-62ef-4d83-94dc-a98fbae9b50b");

define("client_secret", "UpfNlhNS7H9KhvnXY5z3.UU_OhQBBB/-");
// UpfNlhNS7H9KhvnXY5z3.UU_OhQBBB/-
define("callback_uri", "https://mysunless.com/crm/php-skydrive-master/example/callback.php");

define("skydrive_base_url", "https://graph.microsoft.com/v1.0/");
