...
if (!$token)  { // If no token, prompt to login. Call skydrive_auth::build_oauth_url() to get the redirect URL.
	...
	echo "<span style='vertical-align: middle;'><a href='".skydrive_auth::build_oauth_url()."'>Login</a></span>";
	echo "</div>";
...
// 	echo "</p>";
// 	echo "<p><b>Uplode folder here:<br>";
// 	echo "<form method='post' action='upload.php' enctype='multipart/form-data'><input type='hidden' name='folderid' value='".@$_GET['folderid']."'><input type='file' name='uploadfile' placeholder='Folder Name'>&nbsp;<input type='submit' name='submit' value='submit'></form>";
// 	echo "</p>"; 
