    ...
    "autoWidth": false,
      ...
      },
      {
        ...
        render:function(data,type,row,meta)
        {
           ...
           // console.log(dateEventFormat);
            ...
            return  '<div class="activeuserdetial"><h5><b>'+row.title+'</b></h5><span><h6 style="display: inline-block;">Service Name : </h6> </span><span>'+row.ServiceName +' <br /> </span><span> <h6 style="display: inline-block;">Service Date : </h6> </span>'+row.EventDate+' <br /> <span> <h6 style="display: inline-block;">Service Status : '+row.eventstatus+'</h6> </span></div>';
      ...
      , 
      {
        ...
        "render": function(data,type,row,meta) {
          ...
          return "<div class=''><a class='btn btn-info btn-xs EditButton' style='color: white' id='EditButton' title='Edit Appointment' data-id="+encodedId+"><span class='fa fa-edit'><span></a> <a class='btn btn-danger btn-xs ' style='color: white' id='deleteAppointment' title='Delete Appointment' data-id="+encodedId+" ><span class='fa fa-trash'><span></a></div><br /><div class='usertime'><div class='activeusertime  badge badge-pill badge-primary'>"+getEventTimeWidget+"</div></div>";
