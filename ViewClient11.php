    ...
    <div class="modal-dialog modal-lg" style="max-width: 1100px;">
      ...
      <div class="modal-body">
          ...
          <form class="form-horizontal" action="" autocomplete="off" method="post" id="NewClient2">
              ...
              {
                  ?>
                  <input type="hidden" name="sid" id="sid" value="<?php echo $Createdfk;?>">
                  <?php
              }
              else
              {
...
"columns" : [ 
{
    ...
    render:function(data,type,row,meta){
        ...
        if(row.userimg == '' || row.userimg == null || row.userimg === '')
        {
            ...
            return '<div class="activeuserimage text-center"><img src="<?php echo base_url; ?>/assets/images/noimage.png" alt="user" class="" height="50px" width="50px"> <br /><label><h6>'+row.username+'</h6></label></div>';

        }
        else
        {
            return '<div class="activeuserimage text-center"> <img src="<?php echo base_url; ?>/assets/userimage/'+row.userimg+'" alt="user" class="" height="50px" width="50px"> <br /><label><h6>'+row.username+'</h6></label></div>';
...
},
{
    ...
    render:function(data,type,row,meta)
    {
       ...
       var ret= '<div class="activeuserdetial" ><span><h5><b>'+row.noteTitle+'</b></h5></span><span><h6 style="display: inline-block;">Note detail : </h6> </span><span class="more_text" >';
       var noteDetail = row.noteDetail;
       var showcharacter = 60;
       var ellipsestext = ".....";
...
$(document).on('click','.morelink',function(e){
   ...
   , 
   {
    ...
    "render": function(data,type,row,meta) {
      ...
      var eventDateDiff = diffYMDHMS(row.newdate);
            ...
            {   
                ...
                if(data.resonse)
                {
                    $('#noteTitle_view').text(data.resonse.noteTitle);
                     //var noteDetails=$.parseHTML(  );
                     $('#noteDetails_view').html(data.resonse.noteDetail);
                                          //$('#noteDetails_view').data("wysihtml5").editor.setValue(data.resonse.noteDetail);
                                          //$('.editnoteid').val(data.resonse.id);
                                          // NotedataTable(data.resonse.noteRelated)
  ...
  success: function(data)
  {
     ...
     {    
        ...
        { 
          ...
          if(useradd == null)
          {
           var useradd= '<?php echo $Createdfk; ?>';
       }
                                        ...
                                        jQuery.ajax({
                                            ...
                                            success: function(data)
                                            {
                                                if(data.resonse)
                                                {
                                                    ...
                                                    $("#resonse_service").show().fadeOut(2000);
                                                ...
                                                {
                                                    $("#error_service").show().fadeOut(2000);
        ...
        $.ajax({
         ...
         success: function(data)
         {
            ...
            $('#editServiceProvider').val(data.resonse.ServiceProvider);
                         ...
                         var curntuser='<?php echo $Createdfk; ?>';
                         $.ajax({
                             dataType:"json",
                             type:"post",
                             data: {'curntuser':curntuser},
