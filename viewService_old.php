...
if($action == "delete"){
    $DeleteUser = $db->prepare("delete from `Service` where id=:myservie");
    $DeleteUser->bindValue(":myservie",$myservie,PDO::PARAM_INT);
    $DeleteUser->execute();
...
<button type="submit" class="btn waves-effect waves-light btn-info m-r-10" id="add-client"> <i class="fa fa-check"></i> <?php echo $B3; ?></button>
                                     ...
                                     ?>
<!-- <a href="<?php echo base_url; ?>/viewService.php" type="button" class="btn waves-effect waves-light btn-danger"><i class="fa fa-times"></i> <?php echo $B4; ?></a> -->
                                        </div>
                            </form>
...
else
{
                                ...
                                <button type="submit" class="btn waves-effect waves-light btn-info m-r-10" id="add-client"> <i class="fa fa-check">
                                                        ...
                                                        ?>
                                                        <!-- <a href="<?php echo base_url; ?>/AllCategory.php" type="button" class="btn waves-effect waves-light btn-danger"><i class="fa fa-times">
                                                            </i> <?php echo $B8; ?></a> -->
                                                    </div>
                                                </form>
...
if ($.isNumeric(text)) {
  ...
  $(document).ready(function(){
        ...
        $('#myTable').DataTable({
            ...
            "destroy": true,
            "ajax" : {
                "url" : "<?php echo EXEC; ?>Exec_AllService.php",
                dataSrc : ''
            }
            ,
            "autoWidth": false,
        ...
        swal({
                title: "Are you sure?",
                text: "Once deleted, you will lost all data of this service!",
                icon: "warning",
                buttons: true,
            }).then((willDelete)=>{   
                if (willDelete){
                    ...
                    $.ajax({
                            ...
                            url:'?action=deletefile',
                                ...
                                if(data.resonse)
                                {
                                 ...
                                 $('#Info').data("wysihtml5").editor.setValue(data.resonse.Info);
         ...
         $(document).on('click','#addUserser',function(e){
                ...
                submitHandler: function() {
                    ...
                    jQuery.ajax({
                        ...
                        type:"post",
                        data:data,
                        url:'<?php echo EXEC; ?>Exec_Edit_Category.php',
                        success: function(data)
                        {
                            if(data.resonse)
                            {
