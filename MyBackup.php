...
if(isset($_POST['disbleid']))
{
	...
	if($query)
	{
		echo  json_encode(["resonse"=>'Your Gmail Account Successfully Disabled']);die;
	}
}
...
if(isset($_POST['select_day']))
{
	...
	if(empty($last_bacup_duration))
	{
		...
		{
			echo json_encode(["resonse"=>'Your Backup Reminder Successfully Set']);die;
		}
		...
		if($stmt)
		{
			echo  json_encode(["resonse"=>'Your Backup Reminder Successfully Update']);die;
		} 
	} 
									...
									<div class="p-2">
										...
										<div class="modal-content mysunless_filter_pos_right" id="mysunless_filter_box" style="width:400px">
											...
											<div class="modal-body">
												<div>
													<label class='m-0'>Select Duration</label>
													<select class="custom-select ml-auto" id="Upcomingbackup">
														<?php
														$oldbackup= $db->prepare("SELECT * FROM `BackupReminder` WHERE createdfk=:createdfk");
														$oldbackup->bindParam(':createdfk',$_SESSION['UserID']);
														$oldbackup->execute();
														$last_backup= $oldbackup->fetch();
														$duration= $last_backup['duration'] ;
														if(empty($duration))
															{?>
												...
												<div class="card-body">
													<div class="row" style="display: flex">
														...
														<div class="integrate-div col-md-3 col-lg-3">
															<a href="#" class="integrate-logo-div csv">
																<img class="quickbooks-integrate" src="<?php echo base_url ;?>/assets/images/excel_logo.png" height="100%">
															</a>
															<div class="integration-title">Excel</div>
														</div>

														<div class="integrate-div col-md-3 col-lg-3">
															<a href="<?php echo base_url?>/googledrivebackup" class="integrate-logo-div">
																<img class="quickbooks-integrate" src="<?php echo base_url ;?>/assets/images/google_logo.png" height="100%">
															</a>
															<div class="integration-title">Google</div>
														</div>

														<div class="integrate-div col-md-3 col-lg-3">
															<a href="<?php echo base_url?>/onedrive/index" class="integrate-logo-div">
																<img class="quickbooks-integrate" src="<?php echo base_url ;?>/assets/images/onedrive_logo.png" height="100%">
															</a>
															<div class="integration-title">One Drive</div>
														</div>

														<div class="integrate-div col-md-3 col-lg-3">
															<a href="<?php echo base_url?>/DropPHP-master/samples/upload-form" class="integrate-logo-div">
																<img class="quickbooks-integrate" src="<?php echo base_url ;?>/assets/images/Dropbox_logo.png" height="100%">
															</a>
...
<script type="text/javascript">
    ...
    $(document).on('click','.csv',function(){
      ...
      //$('input[name="deleteCheck"]:checked').each(function(){
       // var values =window.atob($(this).val());
      //  data.push(values);
      //});

      var base_url = '<?php echo $SUB ?>';
      var url = "https://mysunless.com"+base_url+"/exportcsv.php?ids="+data;
