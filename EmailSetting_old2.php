...
if(isset($_GET['update'])){
    ...
    if(!empty($_POST['emailname'])){
        ...
        if($_POST['emailname']=='sendForgetMail' || $_POST['emailname']=='registration'){
                        ...
                        <div class="col-md-12">
                           ...
                           <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="Config" role="tabpanel">
                                ...
                                <ul class="nav nav-tabs customtab" role="tablist">
                                    <li class="nav-item">
                                       <a class="nav-link active" data-toggle="tab" href="#RegisterEmail" role="tab">
                                        Register Email
                                    </a> 
                                </li>
                                <li class="nav-item">
                           ...
                           <div class="col-lg-12">
                            <div class="tab-content">
                                <div class="tab-pane active" id="RegisterEmail" role="tabpanel">
                                    <small>This email is used for Registration.</small>
                                    <div class="p-20">
                                        <div class="Loader"></div>
                                        <form class="form-horizontal admin_form" id="registration" method="post">
                                            <input type="hidden" name="emailname" value="registration">
                                            <div class="row">
                                             <div class="col-md-2">
