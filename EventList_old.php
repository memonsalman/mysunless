...
<script>
    ...
    function dataTable(EventFilter){
      ...
      },
      {
        ...
        "render": function(data, type, row) {
          ...
          if(data.ProfileImg){
            return '<div class="row"><div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"><img title="View Customer Profile" id="viewInfo" data-cid="'+encodedId+'" src="<?php echo $base_url ?>/assets/ProfileImages/'+data.ProfileImg+'" class="img-circle " style="height: 50px; width: 50px; vertical-align:middle ;" /></div><div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"><span style="text-transform: capitalize;"> '+ data.FirstName +' '+ data.LastName +'</span></div></div>';    
          }
          else
          {
  ...
  },
  {
   ...
   "render" : function(data,type,row){
    ...
    return '<span class="btn btn-sm btn-info EditEvent" data-id="'+btoa(data.id)+'">Edit</span>'+OrderID;
  }              
},
...
EventListTable.ajax.reload( function ( data ) {
